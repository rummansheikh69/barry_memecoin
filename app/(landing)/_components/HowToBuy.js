  ...
  return (
    <div id="buy" className="max-w-[85rem] mx-auto p-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-36 justify-items-center">
        ...
        <OrderCard order={3} title={"swap $Sol for $BARRY"} style={"-rotate-1"}>
          <span>
            ...
            for{" "}
            <span className="font-extrabold text-2xl text-duis">$BARRY</span>.
            {`There's zero taxes so you don’t need to worry.`}
          </span>
        </OrderCard>
        <OrderCard order={4} title={"you're barry-dawg!‍"} style={"rotate-2"}>
          <span>
            Welcome to the <br />
